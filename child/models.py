...
#    size_ad = models.ForeignKey(Adultmodel, on_delete=models.CASCADE,related_name='size_ad',null=True)
#    ad_date = models.ForeignKey(Adultmodel, on_delete=models.CASCADE,related_name='ad_date',null=True)
